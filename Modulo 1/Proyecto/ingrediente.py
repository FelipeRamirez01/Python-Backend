...
@property
def es_vegatariano(self) -> bool:
    """ Devuelve el valor del atributo privado 'es_vegatariano' """
    return self.__es_vegatariano

@es_vegatariano.setter
def es_vegatariano(self, value:bool) -> None:
    """ 
    Establece un nuevo valor para el atributo privado 'es_vegatariano'

    Valida que el valor enviado corresponda al tipo de dato del atributo
    """ 
    if isinstance(value, bool):
        self.__es_vegatariano = value
    else:
